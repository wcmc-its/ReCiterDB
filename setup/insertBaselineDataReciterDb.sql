...
INSERT INTO `admin_settings`
(`viewName`, `viewAttributes`, `viewLabel`)
VALUES('viewProfile', '[{"labelUserKey":"h-index","labelUserView":"h-index","labelSettingsView":"h-index (NIH)","helpTextUserView":"h-index is the number of an author''s articles in PubMed that have been cited, as defined by NIH''s iCite service, at least that many times. ","helpTextSettingsView":"","isVisible":true},{"labelUserKey":"h5-index","labelUserView":"h5-index","labelSettingsView":"h5-index (NIH)","helpTextUserView":"h5-index is the number of an author''s articles in PubMed that have been cited,  as defined by NIH''s iCite service, at least that many times within the past 5 years. ","helpTextSettingsView":"","isVisible":true},{"labelUserKey":"hindexScopus","labelUserView":"h-index (Scopus)","labelSettingsView":"h-index (Scopus)","helpTextUserView":"h-index is the number of an author''s articles in Scopus that have been cited, as defined by Scopus, at least that many times.","helpTextSettingsView":"","isVisible":false},{"labelUserKey":"h5IndexScopus","labelUserView":"h5-index (Scopus)","labelSettingsView":"h5-index (Scopus)","helpTextUserView":"h-index is the number of an author''s articles in Scopus published in the last five years that have been cited, as defined by Scopus, at least that many times.","helpTextSettingsView":"","isVisible":false}]', 'View Profile');
UNLOCK TABLES;
