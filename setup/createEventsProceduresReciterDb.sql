...
proc_main: BEGIN
    ...
    -- Populate using person_person_type to derive facultyRank (legacy logic)
    ...
    -- ========================================================================
    -- STEP 4b: Compute article counts (legacy logic)
    -- Counts are for articles with publicationTypeNIH = 'Research Article'
    -- and percentileNIH is not null
    -- ========================================================================
    CALL log_progress(v_job_id, v_step, 'Updating article counts (legacy logic)', 'RUNNING', NULL, NULL);
    ...
    -- ========================================================================
    -- STEP 5: Compute percentile rankings (legacy logic)
    ...
    CALL log_progress(v_job_id, v_step, 'Computing percentiles (legacy avg of top N)', 'RUNNING', NULL, NULL);
