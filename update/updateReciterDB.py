...
def load_person_person_type2(mysql_cursor):
...
#    load_person_person_type_query = (
#        """        
#        LOAD DATA LOCAL INFILE '/Users/paulalbert/Documents/GitHub/ReCiterDB/update/temp/parsedOutput/person_person_type.csv' INTO TABLE person_person_type FIELDS TERMINATED BY '|' ENCLOSED BY '\"' IGNORE 0 LINES (personIdentifier,personType);                      
#        """
#    )
...
#    print(load_person_person_type_query)
...
#    load_person_person_type2(reciter_db_cursor)
