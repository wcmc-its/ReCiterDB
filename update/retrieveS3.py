...
'''
#        bucket.download_file(object.key,object.key,str('tempS3Output/'))

#        if not os.path.exists(os.path.dirname(object.key)):
#            os.makedirs(os.path.dirname(object.key))    
#        download_path = '/tempS3Output/{}'.object.key
#        bucket.download_file(object.key, download_path)

# boto3.resource('s3').Bucket(bucketName).download_file(object.key,object.key, Filename=download_path)
...
# originalDataPath = '/Users/paulalbert/Documents/GitHub/ReCiterDB/update/AnalysisOutput/' 
